# -*- coding: utf-8 -*-
#
# pycast documentation build configuration file, created by
# sphinx-quickstart on Sat Nov 17 16:57:26 2012.
#
...
project = u'pycast'
copyright = u'2012-2015, Christian Schwarz'
...
latex_documents = [
  ('index', 'pycast.tex', u'pycast Documentation',
   u'Christian Schwarz', 'manual'),
]
...
man_pages = [
    ('index', 'pycast', u'pycast Documentation',
     [u'Christian Schwarz'], 1)
]
...
texinfo_documents = [
  ('index', 'pycast', u'pycast Documentation',
   u'Christian Schwarz', 'pycast', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2012-2015, Christian Schwarz'
